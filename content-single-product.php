	...
	<div class="primary_block sns_main_products row clearfix">
		...
		<div class="summary entry-summary col-md-7 col-sm-6">
			...
			<?php
				...
				if (!function_exists('woocommerce_product_custom_field'))
				{
					function woocommerce_product_custom_field() {
						echo '<div class="wrap-custom-field">';
			...
			<?php
				...
				add_action('woocommerce_single_product_summary', 'woocommerce_product_custom_field', 60);
