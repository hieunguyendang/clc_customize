	...
	function widget( $args, $instance ) {
		...
		if($dropdown){
			...
			jQuery(document).ready(function() {
				jQuery("#lct-widget-languages").chosen();
				//jQuery("#lct-widget-languages").select2();
				 // jQuery("#lct-widget-languages").selectize({
				 // 	placeholder: "Click here to select ...",
				 // });
				jQuery("div.selectize-input").click(function() {
					console.log("aaaaaaa");
				  	//jQuery("#lct-widget-languages option:selected").remove();
				  	//jQuery(".selectize-input").children(".item").empty();
				});
        	});
			</script>';
		}
